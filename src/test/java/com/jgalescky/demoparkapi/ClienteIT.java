...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteStatus201() {
        ClienteCreateDto responseBody = testClient
                .post()
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "42007458012"))
                .exchange()
                .expectStatus().isCreated() // Código 201
                .expectBody(ClienteCreateDto.class)
    ...
    @Test
    public void buscarCliente_ComIdExistentePeloCliente_RetornarErrorMessageStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/0")
    ...
    public void buscarCliente_ComDadosDoTokenDeCliente_RetornarClienteComStatus200() {
        ...
        // A classe Assertions = fornece os métodos que vão testar o objeto
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("00891800034");
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Bianca Silva");
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(10);
    }

    @Test
    public void buscarCliente_ComDadosDoTokenDeAdministrador_RetornarErrorMessageStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
