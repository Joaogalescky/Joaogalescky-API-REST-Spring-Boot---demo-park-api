...
import com.jgalescky.demoparkapi.service.JasperService;
...
public class EstacionamentoController {
    ...
    @Operation(summary = "Localizar os registros de estacionamentos do cliente por CPF", description = "Localizar os "
            + "registros de estacionamentos do cliente por CPF. Requisição exige um Bearer Token.",
            security = @SecurityRequirement(name = "security"),
            parameters = {
    ...
    @Operation(summary = "Localizar os registros de estacionamentos do cliente logado",
            description = "Localizar os registros de estacionamentos do cliente logado"
                    + "Requisição exige um Bearer Token.",
            security = @SecurityRequirement(name = "security"),
            parameters = {
    ...
    public ResponseEntity<PageableDto> getAllEstacionamentosDoCliente(@AuthenticationPrincipal JwtUserDetails user, @Parameter(hidden = true) @PageableDefault(
