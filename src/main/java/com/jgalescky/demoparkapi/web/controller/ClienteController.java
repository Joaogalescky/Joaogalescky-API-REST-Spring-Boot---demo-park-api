...
import com.jgalescky.demoparkapi.web.dto.mapper.PageableMapper;
...
public class ClienteController {
    ...
    @Operation(summary = "Recuperar lista de clientes", description = "Requisição exige um Bearer Token. Acesso restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            parameters = {
                    ...
                    @Parameter(in = QUERY, name = "sort", hidden = true, array = @ArraySchema(schema = @Schema(type = "string", defaultValue = "id,asc")),
                            description = "Representa a ordenação dos resultados. Aceita multiplos critérios de ordenação que são suportados"
                    )
            },
            responses = {
